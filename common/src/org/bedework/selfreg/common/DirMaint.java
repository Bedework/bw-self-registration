...
public interface DirMaint {
   ...
   * @param accountName - supplied by user
	 ...
	 * @throws Throwable
	 */
	boolean confirm(String confId) throws Throwable;
	 ...
	 * @throws Throwable
	 */
	boolean lostId(String email) throws Throwable;
   ...
   * @throws Throwable
   */
  boolean lostPw(String id) throws Throwable;
   ...
   * @throws Throwable
   */
  boolean confirmPwChange(String confid) throws Throwable;
